...
def plantMazeWalls(matrix):
    ...
    for i in range(10):
        for j in range(10):
            if (i == 1 and j in [1, 2, 3]) or (i == 2 and j in [3, 4, 5]) or (i == 3 and j in [5, 6, 7]) or (i == 4 and j in [7, 8, 9]) or (i == 5 and j in [1, 2, 3]) or (i == 6 and j in [3, 4, 5]) or (i == 7 and j in [5, 6, 7]) or (i == 8 and j in [7, 8, 9]):
                matrix[i][j] = '#' 
